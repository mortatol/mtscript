...
./mtproto-proxy -u nobody -p 8888 -H 9999 -S 5717cd718527e90e5823998620571aa9 -P 92628c2693651edd8be60993a91bb86d --aes-pwd proxy-secret proxy-multi.conf -M 1 --allow-skip-dh &
